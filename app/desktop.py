...
class JarvisWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        page.setContentsMargins(30, 22, 30, 22)
        page.setSpacing(12)
        header = QHBoxLayout()
        header.addWidget(label("J.A.R.V.I.S.", "brand"))
        header.addStretch()
        ...
        self.chat_card.setFixedHeight(210)
        self.chat_card.hide()
        ...
        self.talk = button("TALK TO JARVIS")
        ...
        self.send = button("SEND")
        self.send.clicked.connect(lambda: self._send())
        control_layout.addWidget(self.send)
        control_layout.addStretch()
        control_layout.addWidget(label('Say "hide controls" to return to the core.\nF2 toggles this panel. Ctrl+Space activates the mic.', "muted", True))
